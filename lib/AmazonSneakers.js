...
AmazonSneakers.prototype.query = function(queryStr, options, cb) {  
	if (!this.__AWSQueryBuilder.keysValid()) return cb('AWS Key and/or Secret were not set correctly');
  if (typeof queryStr === 'undefined') return cb('undefined is not a valid search text');  
