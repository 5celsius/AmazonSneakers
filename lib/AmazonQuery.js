...
AmazonQuery.prototype.keysValid = function(options){
  return (
    this.__AWSKey && 
    this.__AWSPass && 
    _.isString(this.__AWSKey) && 
    _.isString(this.__AWSPass));
}
...
AmazonQuery.prototype.buildParams = function(options) {
  ...
  if (options.gender) { params.Title = options.gender + ' ' + params.Title };
